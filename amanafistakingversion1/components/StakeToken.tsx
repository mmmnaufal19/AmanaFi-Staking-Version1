                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {loadingStakeTokenBalance ? (
                            ...
                            <p style={{
                                ...
                                borderRadius: "5px",
                                marginRight: "5px",
                            }}>$ISLMT: {truncate(toEther(stakingTokenBalance!),2)}</p>
                        )}
                        {loadingRewardTokenBalance ? (
                            ...
                            <p style={{
                                padding: "10px",
                                borderRadius: "5px",
                            }}>$DEEN: {truncate(toEther(rewardTokenBalance!),2)}</p>
                        )}
                    </div>
                    ...
                    {stakeInfo && (
                        <>
                            ...
                            <div>
                                <p>$ISLM Staked for Waqf: {truncate(toEther(stakeInfo[0]).toString(),2)}</p>
                                <p>$DEEN Reward Balance: {truncate(toEther(stakeInfo[1]).toString(),2)}</p>
                                <TransactionButton
                                    transaction={() => (
                                        prepareContractCall({
                                            contract: STAKING_CONTRACT,
